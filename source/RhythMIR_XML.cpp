...
NLTmxMap* NLLoadTmxMap(const char* xml )
{
    ...
    while ( tilesetnode ) {
		unique_ptr<NLTmxMapTileset> tileset(new NLTmxMapTileset());
		...
		while (tilenode) {
			unique_ptr<NLTmxMapTile> tile(new NLTmxMapTile());
    ...
    while ( layernode ) {
		unique_ptr<NLTmxMapLayer> layer(new NLTmxMapLayer());
    ...
    while ( objectgroupnode ) {
		unique_ptr<NLTmxMapObjectGroup> group(new NLTmxMapObjectGroup());
        ...
        while ( objectnode ) {
			unique_ptr<NLTmxMapObject> object(new NLTmxMapObject());
            ...
            if ( propertiesnode ) {
                ...
                while ( propertynode ) {
					unique_ptr<NLTmxMapObjectProperty> property(new NLTmxMapObjectProperty());
